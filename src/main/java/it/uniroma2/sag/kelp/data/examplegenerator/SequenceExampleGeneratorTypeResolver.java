 ...
 * <code>SequenceExamplesGenerator</code>s
 * 
 * @author Simone Filice
 *
 */
public class SequenceExampleGeneratorTypeResolver implements TypeIdResolver {
	private static Logger logger = LoggerFactory.getLogger(SequenceExampleGeneratorTypeResolver.class);

	private static Map<String, Class<? extends SequenceExampleGenerator>> idToClassMapping;
	private static Map<Class<? extends SequenceExampleGenerator>, String> classToIdMapping;

	static {
		Reflections reflections = new Reflections("it");
		idToClassMapping = new HashMap<String, Class<? extends SequenceExampleGenerator>>();
		classToIdMapping = new HashMap<Class<? extends SequenceExampleGenerator>, String>();
		Set<Class<? extends SequenceExampleGenerator>> classes = reflections
				.getSubTypesOf(SequenceExampleGenerator.class);
		for (Class<? extends SequenceExampleGenerator> clazz : classes) {
